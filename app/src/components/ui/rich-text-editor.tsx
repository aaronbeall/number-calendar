      ...
      <Editor
        ...
        containerProps={{
          ...
          className: cn(
            ...
            "[&_.rsw-toolbar]:!flex [&_.rsw-toolbar]:!flex-nowrap [&_.rsw-toolbar]:!items-center [&_.rsw-toolbar]:!gap-0 [&_.rsw-toolbar]:!border-b [&_.rsw-toolbar]:!border-slate-200 [&_.rsw-toolbar]:!bg-slate-100/80 [&_.rsw-toolbar]:!px-1 [&_.rsw-toolbar]:!py-0.5 dark:[&_.rsw-toolbar]:!border-slate-800 dark:[&_.rsw-toolbar]:!bg-slate-900",
            "[&_.rsw-btn]:!h-6 [&_.rsw-btn]:!w-6 [&_.rsw-btn]:!rounded-md [&_.rsw-btn]:!text-[12px] [&_.rsw-btn]:!text-slate-700 dark:[&_.rsw-btn]:!text-slate-100 [&_.rsw-btn]:!transition-colors [&_.rsw-btn:hover]:!bg-slate-200/80 dark:[&_.rsw-btn:hover]:!bg-slate-800 [&_.rsw-btn[data-active=true]]:!bg-slate-200/90 dark:[&_.rsw-btn[data-active=true]]:!bg-slate-800",
            "[&_.rsw-separator]:!mx-0 [&_.rsw-separator]:!h-4 [&_.rsw-separator]:!w-px [&_.rsw-separator]:!bg-transparent [&_.rsw-separator]:!border-r [&_.rsw-separator]:!border-slate-300/90 dark:[&_.rsw-separator]:!border-slate-600/60",
