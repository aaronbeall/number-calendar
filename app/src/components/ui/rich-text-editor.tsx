    ...
    return (
      <Editor
        ...
        containerProps={{
          ...
          className: cn(
            "rsw-theme !overflow-hidden !rounded-md !border !border-slate-200 !bg-white !shadow-none ring-offset-white focus-within:outline-none focus-within:ring-2 focus-within:!ring-slate-900/30 focus-within:!ring-offset-2 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50 dark:!border-slate-800 dark:!bg-slate-950 dark:!ring-offset-slate-950 dark:focus-within:!ring-slate-200/30",
            ...
            "[&_.rsw-separator]:!mx-0.5 [&_.rsw-separator]:!h-4 [&_.rsw-separator]:!w-px [&_.rsw-separator]:!bg-slate-300 dark:[&_.rsw-separator]:!bg-slate-700",
