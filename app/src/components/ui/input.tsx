...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, hideStepperButtons: hideSpinButtons, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          ...
          hideSpinButtons && "[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none",
          className
        )}
        ref={ref}
        {...props}
